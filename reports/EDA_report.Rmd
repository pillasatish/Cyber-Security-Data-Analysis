...
```{r, echo=FALSE, out.width="100%", fig.height=3, fig.width=6, fig.align = 'center', fig.cap="Education level Distrubtion"}
...
```{r, echo=FALSE, out.width="100%", fig.height=4, fig.width=9, fig.align = 'center', fig.cap="Employment status Distrubtion"}
